...
$val .= '
				<button type="button" class="ss-uploadfield-fromfiles ss-ui-button ui-corner-all" title="';
...
$val .= '
					<button type="button" class="ss-uploadfield-startall ss-ui-button ui-corner-all" data-icon="navigation">';
