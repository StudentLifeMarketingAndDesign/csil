...
$val .= '" class="staff-link">
            ...
            <img src="division-project/images/dosl.png" alt="Photograph of ';
...
if ($scope->locally()->hasValue('Position', null, true)) { 
$val .= '<small class="staff-position">';

$val .= $scope->locally()->XML_val('Position', null, true);
$val .= '</small>';
