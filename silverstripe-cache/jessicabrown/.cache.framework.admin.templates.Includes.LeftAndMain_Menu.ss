...
$val .= '" class="logout-link font-icon-logout" title="';
...
$val .= '
	...
	<div class="cms-panel-toggle south">
		...
		<a class="toggle-expand" href="' . (\Config::inst()->get('SSViewer', 'rewrite_hash_links')
	? \Convert::raw2att( preg_replace("/^(\\/)+/", "/", $_SERVER['REQUEST_URI'] ) )
	: "") . '#"><span>&raquo;</span></a>
		<a class="toggle-collapse" href="' . (\Config::inst()->get('SSViewer', 'rewrite_hash_links')
	? \Convert::raw2att( preg_replace("/^(\\/)+/", "/", $_SERVER['REQUEST_URI'] ) )
	: "") . '#"><span>&laquo;</span></a>
	</div>
</div>
