<div class="pick-one-header">
	<div class="row">
	    <div class="large-7 columns clearfix">
			<h1>Pick One!</h1>
  ...
  <section class="pick-one container content-wrapper clearfix">
	  <div class="row">
	  	<div class="categories large-6 columns">
	  		...
	  		<div class="category">
	  			<div class="category-header $EvenOdd"><h3>$Title</h3> <a href="#" class="expand"><span class="visuallyhidden">Expand $Title</span></a>	<div class="clearfix"></div></div>
	  	...
	  	<div class="testimonials large-6 columns">
	  		...
	  		<div class="testimonial row $FirstLast">
	  		
	  		
	  		<% if $Photo %>
	  			<div class="photo-container large-4 columns">
	  				$Photo
	  			</div>
