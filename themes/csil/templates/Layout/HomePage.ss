  ...
  <div class="flexslider">
      ...
      <ul class="slides">
        ...
        <li>
          ...
          <p class="flex-caption"><a href="$Image.URL" class="full-desc" target="_blank">$Description.NoHTML</a><a class="mobile-desc">$Description.NoHTML.LimitCharacters(60)</a></p>
        </li>
        <% end_loop %>
       </ul><!-- end slides -->
  </div><!-- end container -->
